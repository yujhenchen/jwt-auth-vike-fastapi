Generated with [vike.dev/new](https://vike.dev/new) ([version 449](https://www.npmjs.com/package/create-vike/v/0.0.449)) using this command:

```sh
bun create vike@latest --react --tailwindcss --shadcn-ui --vercel --biome
```
